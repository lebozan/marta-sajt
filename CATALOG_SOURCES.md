...
The draft products created by `node prisma/seed-catalog.js` use free Unsplash photographs. They are intentionally inactive until MARTA confirms the photographed item, its copy, and its price.
...
Source pages state that these photographs are available under the Unsplash License. Keep this record, and replace each image with MARTA-owned product photography before representing it as exact sale inventory.
